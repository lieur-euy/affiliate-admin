...
const CPU_FIELDS: SpecField[] = [
  ...
  { key: "series", label: "Series (Ryzen / Core i9 / Core Ultra...)" },
  { key: "model", label: "SKU / Model" },
  { key: "family", label: "Family (Ryzen 9000 Series...)" },
  { key: "architecture", label: "Architecture (Zen 5 / Raptor Lake...)" },
  { key: "codename", label: "Codename (Granite Ridge...)" },
  ...
  { key: "l1_cache", label: "L1 Cache (KB)" },
  { key: "l2_cache", label: "L2 Cache (KB)" },
  { key: "l3_cache", label: "L3 Cache (KB)" },
  ...
  { key: "security", label: "Security (AES-NI, SHA, NX, SGX...)" },
  { key: "virtualization", label: "Virtualization (VT-x, VT-d, AMD-V...)" },
  { key: "platform_tier", label: "Platform Tier (vPro, AMD PRO, SIPP...)" },
  { key: "tdp_config", label: "Configurable TDP" },
  { key: "compatible_chipsets", label: "Compatible Chipsets (B450,B550,X570...)" },
